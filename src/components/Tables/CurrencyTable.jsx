...
import { currenciesData, currenciesTabletitle, customersTabletitle } from './tabledata'
...
const CurrencyTable = () => {
    return (
        <TableSystemwrapper TableHead={<TableHead tabletitle={currenciesTabletitle} />}
            TableBody={<TableBody tabledata={currenciesData} />}
        />
    )
}
        ...
        <div className="p-6 w-100 md:w-[60vw]">
            <div className="p-6 bg-base-300 rounded-md flex justify-between items-center">
                <div className="flex flex-col gap-2">
                    <h2 className='text-xl'>Update Currency</h2>
                    <p className='text-sm'>Updated your currency and necessary information from here</p>
                </div>
